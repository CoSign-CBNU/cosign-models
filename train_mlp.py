...
X_PATH = os.path.join(TRAIN_DATASET_DIR, "X_seq.npy")
Y_PATH = os.path.join(TRAIN_DATASET_DIR, "y.npy")
...
def main():
    ...
    print("\n=== 5-Fold Cross Validation on ALL samples ===")
    ...
    print(f"\n{'=' * 60}")
    print("=== Cross Validation Summary (ALL samples) ===")
    print(f"{'=' * 60}")
